                    ...
                    <div class="col-lg-6">
                        ...
                        <p>
                            <button class="btn btn-success btn-lg btn-block paystack-btn margin-top-30" type="submit" value="Pay Now!">
                                <?php echo e('Pay'); ?> <?php echo e($paystack_data['price'].get_charge_currency('paystack')); ?> <?php echo e(__(' Now!')); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/frontend/payment/paystack.blade.php ENDPATH**/ ?>