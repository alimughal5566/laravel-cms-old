                ...
                <div class="col-lg-12">
                   ...
                   <div class="cart-wrapper">
                                          ...
                                          <div class="card-body">
                                             <div class="shipping-table-wrap table-responsive">
                                                 ...
                                                 <div class="btn-wrapper">
                                                     <a href="#" class="btn-boxed add_shipping"><?php echo e(__('Apply Shipping')); ?></a>
                       ...
                       <div class="cart-total-wrap">
                           ...
                           <a href="<?php echo e(route('frontend.products.checkout')); ?>" class="btn-boxed"><?php echo e(__('Process To Checkout')); ?></a>
                       </div>
                       <?php endif; ?>
                   </div>
                </div>
    ...
    <script>
        (function ($) {
            ...
            function setDefaultShippingCost() {
                var defaultShippingValue = $('input[name="shipping_id"]').val();
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/products/product-cart.blade.php ENDPATH**/ ?>