...
<!doctype html>
<html class="no-js" lang="<?php echo e(get_default_language_direction()); ?>"  dir="<?php echo e(get_default_language_direction()); ?>">
...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area">
            ...
            <p><?php echo __('Powered By ').'<a href="https://codecanyon.net/item/nexelit-multipurpose-website-business-management-system-cms/27936384">Nexeit '.get_static_option('site_script_version').'</a>'; ?></p>
        </div>
    </footer>
