        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <?php endif; ?>
                    <?php if(check_page_permission_by_string('Donations Manage') && !empty(get_static_option('donation_module_check'))): ?>
                    <li class="
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>