                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div class="row">
                                    ...
                                    <?php endif; ?>
                                    <?php if(get_static_option('donation_module_check')): ?>
                                    <div class="col-lg-6">
                                        <div class="user-dashboard-card style-01">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <?php $__currentLoopData = $package_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(site_currency_symbol().$data->package_price); ?></td>
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        <span class="alert alert-success text-capitalize alert-sm"><?php echo e($data->payment_status); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($data->status == 'pending'): ?>
                                                        <span class="alert alert-warning text-capitalize alert-sm"><?php echo e($data->status); ?></span>
                                                    <?php elseif($data->status == 'canceled'): ?>
                                                        <span class="alert alert-danger text-capitalize alert-sm"><?php echo e($data->status); ?></span>
                                                    <?php elseif($data->status == 'in_progress'): ?>
                                                        <span class="alert alert-info text-capitalize alert-sm"><?php echo e(str_replace('_',' ',$data->status)); ?></span>
                                                    <?php else: ?>
                                                        <span class="alert alert-success text-capitalize alert-sm"><?php echo e($data->status); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <?php $__currentLoopData = $product_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(ucwords(str_replace('_',' ',$data->payment_gateway))); ?></td>
                                                <td>
                                                    <?php if($data->payment_status == 'pending'): ?>
                                                        <span class="alert alert-warning text-capitalize alert-sm"><?php echo e($data->payment_status); ?></span>
                                                    <?php else: ?>
                            ...
                            <div class="tab-pane fade" id="pills-donation" role="tabpanel" aria-labelledby="pills-donation-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th scope="col"><?php echo e(__('Donation ID')); ?></th>
                                            <th scope="col"><?php echo e(__('Donation Case')); ?></th>
                                            <th scope="col"><?php echo e(__('Total Amount')); ?></th>
                                            <th scope="col"><?php echo e(__('Payment Gateway')); ?></th>
                                            <th scope="col"><?php echo e(__('Payment Status')); ?></th>
                                            <th scope="col"><?php echo e(__('Invoice')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $donation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(site_currency_symbol().$data->amount); ?></td>
                                                <td><?php echo e(ucwords(str_replace('_',' ',$data->payment_gateway))); ?></td>
                                                <td>
                                                    <?php if($data->status == 'pending'): ?>
                                                        <span class="alert alert-warning text-capitalize alert-sm"><?php echo e($data->status); ?></span>
                                                ...
                                                <td>
                                                    ...
                                                    <?php else: ?>
                                                        <div class="alert alert-warning"><?php echo e(__('invoice not available')); ?></div>
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo e(date_format($data->created_at,'d M Y')); ?></td>
                                            </tr>
                            ...
                            <div class="tab-pane fade" id="pills-event" role="tabpanel" aria-labelledby="pills-event-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th scope="col"><?php echo e(__('Attendance ID')); ?></th>
                                            <th scope="col"><?php echo e(__('Event Name')); ?></th>
                                            <th scope="col"><?php echo e(__('Event Price')); ?></th>
                                            <th scope="col"><?php echo e(__('Quantity')); ?></th>
                                            <th scope="col"><?php echo e(__('Payment Status')); ?></th>
                                            <th scope="col"><?php echo e(__('Booking Status')); ?></th>
                                            <th scope="col"><?php echo e(__('invoice')); ?></th>
                                            <th scope="col"><?php echo e(__('Date')); ?></th>
                                        </tr>
                                        </thead>
                                        ...
                                        <?php $__currentLoopData = $event_attendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(site_currency_symbol().$data->event_cost); ?></td>
                            ...
                            <div class="tab-pane fade" id="pills-downloads" role="tabpanel" aria-labelledby="pills-downloads-tab">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th scope="col"><?php echo e(__('Product ID')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <th scope="row"><?php echo e($data['id']); ?></th>
                                                <td><a href="<?php echo e(route('frontend.products.single',$data['slug'])); ?>"><?php echo e($data['title']); ?></a></td>
                                                <td><?php echo e(site_currency_symbol().$data['amount']); ?></td>
                                                <td><?php echo e($data['quantity']); ?></td>
                                                <td>
                                                    <span class="alert alert-success text-capitalize alert-sm"><?php echo e(__('Success')); ?></span>
                                                </td>
                                                <td><?php echo e(date_format($data['date'],'d M Y')); ?></td>
                                                <td>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/user/dashboard/user-home.blade.php ENDPATH**/ ?>