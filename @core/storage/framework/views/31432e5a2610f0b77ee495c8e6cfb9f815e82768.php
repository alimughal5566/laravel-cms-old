...
<script>
    (function($){
        ...
        $(document).ready(function ($) {
            // var anchor = $('.metismenu > li.active');
            // var top = $(anchor).offset().top;
            // $('#menu').animate({
            //     scrollTop: $(anchor).offset().top
            // }, 1000);
            // alert('have to work on sidebar selection menu position')
        })
    })(jQuery);
</script>
</body>
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>