   ...
   <div class="srtipe-payment-inner-wrapper">
       ...
       <form action="<?php echo e($stripe_data['route']); ?>" method="post" id="payment-form">
           ...
           <div class="btn-wrapper">
               <button class="submit-btn" id="payment_submit_btn"><?php echo e(__('Pay').'$'.$stripe_data['price']); ?></button>
           </div>
       </form>
   </div>
</div>
...
<?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/frontend/payment/stripe.blade.php ENDPATH**/ ?>