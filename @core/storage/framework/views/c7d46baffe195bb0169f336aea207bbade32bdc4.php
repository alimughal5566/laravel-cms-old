                        ...
                        <form action="<?php echo e(route('admin.general.page.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="from-group">
                                        <label for="work_page_slug"><?php echo e(__('Case Study Page Slug')); ?></label>
                                        ...
                                        <small><?php echo e(__('slug example: case-study')); ?></small>
                                    </div>
                                    <div class="from-group">
                                    ...
                                    <div class="from-group">
                                        ...
                                        <input type="text" class="form-control" id="quote_page_slug" value="<?php echo e(get_static_option('quote_page_slug')); ?>" name="quote_page_slug" placeholder="<?php echo e(__('Slug')); ?>" >
                                        <small><?php echo e(__('slug example: request-quote')); ?></small>
                                    </div>
                                    <div class="from-group">
                                                            ...
                                                            <div class="card-header" id="work_page_<?php echo e($lang->slug); ?>">
                                                                <h5 class="mb-0">
                                                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#work_page_content_<?php echo e($lang->slug); ?>" aria-expanded="false" >
                                                                        <span class="page-title"><?php if(!empty(get_static_option('work_page_'.$lang->slug.'_name'))): ?> <?php echo e(get_static_option('work_page_'.$lang->slug.'_name')); ?> <?php else: ?> <?php echo e(__('Case Study')); ?>  <?php endif; ?></span>
                                                                    </button>
                                                                </h5>
                                                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/general-settings/page-settings.blade.php ENDPATH**/ ?>