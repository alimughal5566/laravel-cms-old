...
<?php if(!empty($site_google_captcha_v3_site_key) && request()->path() == 'home/01' || !empty($site_google_captcha_v3_site_key) && request()->path() == 'home/02' || !empty($site_google_captcha_v3_site_key) && request()->path() == 'home/03' || !empty($site_google_captcha_v3_site_key) && request()->path() == 'home/04' || !empty($site_google_captcha_v3_site_key) && request()->path() == '/'): ?>
    <script
...
<?php /**PATH E:\Installation\xampp\htdocs\ldsmall\@core\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>