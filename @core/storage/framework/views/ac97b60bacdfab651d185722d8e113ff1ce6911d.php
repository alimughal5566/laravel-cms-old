                                        ...
                                        <table id="all_user_table" >
                                            ...
                                            <?php $__currentLoopData = $payment_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(site_currency_symbol()); ?><?php echo e($data->event_cost); ?></td>
                                                    ...
                                                    <td>
                                                       ...
                                                       <form method='post' action='<?php echo e(route('admin.event.payment.delete',$data->id)); ?>'>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/events/event-payment-logs-all.blade.php ENDPATH**/ ?>