                            ...
                            <div class="blog-classic-item-01 margin-bottom-60">
                                ...
                                <div class="content">
                                    <ul class="post-meta">
                                        ...
                                        <li><div class="cats"><i class="fas fa-folder"></i><a href="<?php echo e(route('frontend.blog.category',['id' => $data->category->id,'any' => Str::slug($data->category->name)])); ?>"> <?php echo e($data->category->name); ?></a></div></li>
                                    </ul>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/blog/blog-search.blade.php ENDPATH**/ ?>