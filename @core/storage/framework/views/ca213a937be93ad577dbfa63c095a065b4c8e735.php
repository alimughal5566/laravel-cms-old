            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="global-content">
                        ...
                        <p>
                            <?php echo e(get_static_option('about_page_'.$user_select_lang_slug.'_global_network_description')); ?>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6">
                    <div class="experience-content-02">
                        ...
                        <div class="sign-area">
                            <p><?php echo e(get_static_option('about_page_'.$user_select_lang_slug.'_quote_text')); ?></p>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/about.blade.php ENDPATH**/ ?>