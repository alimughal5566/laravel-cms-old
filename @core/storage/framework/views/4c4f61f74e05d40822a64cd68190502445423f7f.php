    ...
    <div class="stripe-payment-wrapper padding-top-120 padding-bottom-120">
        <div class="srtipe-payment-inner-wrapper">
            ...
            <form method="POST" action="<?php echo e($paystack_data['route']); ?>" accept-charset="UTF-8" class="form-horizontal" role="form">
                <?php echo csrf_field(); ?>
                <?php
                    $package_price = $paystack_data['price'] * get_static_option('site_usd_to_ngn_exchange_rate');
                ?>
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <input type="hidden" name="amount" value="<?php echo e($package_price * 100); ?>"> 
                        ...
                        <p>
                            <button class="btn btn-success btn-lg btn-block paystack-btn margin-top-30" type="submit" value="Pay Now!">
                                <?php echo e('Pay'.' ₦'.$package_price.' '. __('Now!')); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/payment/paystack.blade.php ENDPATH**/ ?>