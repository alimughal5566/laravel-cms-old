...
<section class="what-we-cover padding-bottom-85">
    <div class="container">
        ...
        <?php $a = 1; ?>
        <?php if(get_static_option('home_page_01_service_area_item_type') == 'category'): ?>
...
<?php endif; ?>
<?php if(!empty(get_static_option('home_page_quality_section_status'))): ?>
<div class="global-network-area bg-liteblue padding-bottom-120 padding-top-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="global-content">
                    <h4 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_title')); ?></h4>
                    <p><?php echo get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_description'); ?></p>
                    <?php if(!empty(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_status'))): ?>
                    <div class="btn-wrapper padding-top-25">
                        <a href="<?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_url')); ?>" class="boxed-btn reverse-color"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_title')); ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="map-img">
                    <?php echo render_image_markup_by_attachment_id(get_static_option('home_page_02_quality_area_image')); ?>
        ...
        <div class="row no-gutters">
            <div class="col-lg-6">
                <div class="experience-right style-01"
                     <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_02_about_us_video_background_image')); ?>

                >
                    <div class="vdo-btn">
                        <a class="video-play-btn mfp-iframe" href="<?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_video_url')); ?>"><i class="fas fa-play"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="experience-content-02">
                    ...
                    <p><?php echo get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_description'); ?></p>
                    <div class="sign-area">
                        ...
                        <div class="sing-img padding-top-10">
                            <?php echo render_image_markup_by_attachment_id(get_static_option('home_page_02_about_us_signature_image')); ?>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title desktop-center padding-bottom-20">
                        <h2 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_testimonial_section_title')); ?></h2>
                    </div>
                </div>
            </div>
            <div class="row">
...
<?php if(!empty(get_static_option('home_page_case_study_section_status'))): ?>
    <div class="case-studies-area-02 bg-image padding-bottom-120" <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_02_case_study_background_image')); ?>>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="section-title desktop-center padding-bottom-55">
                    <h3 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_team_member_section_title')); ?></h3>
