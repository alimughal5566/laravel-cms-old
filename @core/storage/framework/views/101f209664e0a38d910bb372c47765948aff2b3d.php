                            ...
                            <ul class="icon-with-title-description">
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="details"><?php echo e(site_currency_symbol().$event->cost); ?></span>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="details">
                                           <a href="<?php echo e(route('frontend.events.category',['id' => $event->category->id,'any'=> Str::slug($event->category->title,'-')])); ?>"> <?php echo e($event->category->title); ?></a>
                                        </span>
                                    </div>
                                </li>
                            </ul>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/events/event-single.blade.php ENDPATH**/ ?>