                            ...
                            <div class="blog-classic-item-01 margin-bottom-60">
                                ...
                                <div class="content">
                                    <ul class="post-meta">
                                        ...
                                        <li><div class="cats"><i class="fas fa-folder"></i><?php echo get_blog_category_by_id($data->id,'link'); ?></div></li>
                                    </ul>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/blog/blog-category.blade.php ENDPATH**/ ?>