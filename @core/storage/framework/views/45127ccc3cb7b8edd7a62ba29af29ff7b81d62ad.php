                                               ...
                                               <div class="col-lg-8">
                                                   <div class="billing-details-fields-wrapper">
                                                       ...
                                                       <div class="form-group">
                                                           ...
                                                           <input type="text" class="form-control" name="billing_street_address" id="billing_street_address">
                                                       </div>
                                                       <div class="form-group">
                                                           <label for="billing_town"><?php echo e(__('Town/City')); ?></label>
                                                           <input type="text" class="form-control" name="billing_town" id="tbilling_own">
                                                       </div>
                                                       <div class="form-group">
                                                           <label for="billing_district"><?php echo e(__('District')); ?></label>
                       ...
                       <div class="cart-total-wrap">
                           ...
                           <?php if(!empty(get_static_option('site_payment_gateway'))): ?>
                               <div class="payment-gateway-wrapper">
                                   <ul>
                                       <?php if(!empty(get_static_option('cash_on_delivery_gateway'))): ?>
                                           <li data-gateway="cash_on_delivery">
                                               <div class="img-select">
                                                   <?php echo render_image_markup_by_attachment_id(get_static_option('cash_on_delivery_preview_logo')); ?>
                           ...
                           <?php endif; ?>
                           <a href="<?php echo e(route('frontend.products.checkout')); ?>" <?php if(!auth()->check()): ?> style="display: none; <?php endif; ?>" class="btn-boxed checkout_form_submit_btn"><?php echo e(__('Confirm Order')); ?></a>
                       </div>
                   </div>
                    <?php else: ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/products/product-checkout.blade.php ENDPATH**/ ?>