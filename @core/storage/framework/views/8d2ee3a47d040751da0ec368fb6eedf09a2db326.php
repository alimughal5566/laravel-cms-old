                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if($data->default == 1): ?>
                                            <a href="javascript:void(0)" class="btn btn-lg btn-success btn-xs mb-3 mr-1"><?php echo e(__("Default")); ?></a>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('admin.languages.words.edit',$data->slug)); ?>" class="btn btn-info btn-xs mb-3 mr-1" style="color: #fff;">
