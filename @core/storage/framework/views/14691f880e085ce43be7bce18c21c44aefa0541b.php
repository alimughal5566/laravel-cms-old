            ...
            <div class="table-responsive cart-table">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th><?php echo e(__('Donation Case')); ?></th>
                        <th><?php echo e(__('Amount')); ?></th>
                    </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td><?php echo e($donation_details->id); ?></td>
                            <td>
                                <div class="thumbnail">
                            ...
                            <td>
                                <span class="product-title"><?php echo e($donation_details->donation->title); ?></span>
                            </td>
                            <td><?php echo e(site_currency_symbol().$donation_details->amount); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/invoice/donation.blade.php ENDPATH**/ ?>