            ...
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    <?php if(check_page_permission_by_string('All Payment Logs')): ?>
                        <li class="main_dropdown <?php echo e(active_menu('admin-home/payment-logs')); ?> <?php echo e(active_menu('admin-home/payment-logs/report')); ?>">
                            <a href="javascript:void(0)"
                               aria-expanded="true">
                                <span><?php echo e(__('Package Payments')); ?></span>
                            </a>
                            <ul class="collapse">
                    ...
                    <li class="main_dropdown <?php echo e(active_menu('admin-home/topbar-settings')); ?>">
                    ...
                    <li class="main_dropdown <?php if(request()->is('admin-home/home-page-01/*')  ): ?> active <?php endif; ?>
