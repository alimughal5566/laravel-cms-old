                                ...
                                <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="tab_<?php echo e($key); ?>" role="tabpanel" >
                                    ...
                                    <?php if(get_static_option('home_page_variant') != '01' ): ?>
                                        <div class="form-group">
                                            ...
                                            <textarea name="home_page_01_<?php echo e($lang->slug); ?>_about_us_description" class="form-control" id="home_page_01_<?php echo e($lang->slug); ?>_about_us_description" cols="30" rows="10"><?php echo e(get_static_option('home_page_01_'.$lang->slug.'_about_us_description')); ?></textarea>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if(get_static_option('home_page_variant') == '04' ): ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="home_page_01_<?php echo e($lang->slug); ?>_about_us_our_mission_description" class="form-control" id="home_page_01_<?php echo e($lang->slug); ?>_about_us_our_mission_description" cols="30" rows="10"><?php echo e(get_static_option('home_page_01_'.$lang->slug.'_about_us_our_mission_description')); ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="home_page_01_<?php echo e($lang->slug); ?>_about_us_our_vision_description" class="form-control" id="home_page_01_<?php echo e($lang->slug); ?>_about_us_our_vision_description" cols="30" rows="10"><?php echo e(get_static_option('home_page_01_'.$lang->slug.'_about_us_our_vision_description')); ?></textarea>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(get_static_option('home_page_variant') == '01'): ?>
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Background Image" data-modaltitle="Upload Background Image" data-imgid="<?php echo e(get_static_option('home_page_01_about_us_video_background_image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                            ...
                            <?php if(get_static_option('home_page_variant') == '02'): ?>
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Background Image" data-modaltitle="Upload Background Image" data-imgid="<?php echo e(get_static_option('home_page_02_about_us_video_background_image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                            <?php echo e(__($background_image_upload_btn_label)); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Signature Image" data-modaltitle="Upload Signature Image" data-imgid="<?php echo e(get_static_option('home_page_02_about_us_signature_image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                            ...
                            <?php if(get_static_option('home_page_variant') == '03'): ?>
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Image" data-modaltitle="Upload Image" data-imgid="<?php echo e(get_static_option('home_page_03_about_us_image_one')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                            <?php echo e(__($background_image_upload_btn_label)); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Image" data-modaltitle="Upload Image" data-imgid="<?php echo e(get_static_option('home_page_03_about_us_image_two')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                            <?php echo e(__($background_image_upload_btn_label)); ?>
                            ...
                            <?php if(get_static_option('home_page_variant') == '04'): ?>
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Image" data-modaltitle="Upload Image" data-imgid="<?php echo e(get_static_option('home_page_04_about_us_our_mission_image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                            <?php echo e(__($background_image_upload_btn_label)); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        ...
                                        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="Select Image" data-modaltitle="Upload Image" data-imgid="<?php echo e(get_static_option('home_page_04_about_us_our_vision_image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                            <?php echo e(__($background_image_upload_btn_label)); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/pages/home/home-01/about-us.blade.php ENDPATH**/ ?>