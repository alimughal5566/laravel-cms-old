                        ...
                        <form action="<?php echo e(route('frontend.clients.feedback.store')); ?>" method="post" class="contact-page-form" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <ul class="ratings_list">
                                    <li data-value="1"><?php echo e(__('1')); ?></li>
                                    <li data-value="2"><?php echo e(__('2')); ?></li>
                                    <li data-value="3"><?php echo e(__('3')); ?></li>
                                    <li data-value="4"><?php echo e(__('4')); ?></li>
                                    <li data-value="5"><?php echo e(__('5')); ?></li>
                                </ul>
                            </div>
                            <div class="form-group">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/feedback-page.blade.php ENDPATH**/ ?>