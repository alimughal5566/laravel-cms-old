                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-donor-info">
                        ...
                        <div class="content">
                            ...
                            <span class="amount"><?php echo e(__("Donate:")); ?> <?php echo e(site_currency_symbol().$data->amount); ?></span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/donor-list.blade.php ENDPATH**/ ?>