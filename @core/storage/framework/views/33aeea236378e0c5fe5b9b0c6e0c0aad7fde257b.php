        ...
        <div class="srtipe-payment-inner-wrapper">
            ...
            <form method="POST" action="<?php echo e($flutterwave_data['form_action']); ?>" id="paymentForm">
                ...
                <div class="btn-wrapper text-center">
                    <input type="submit" class="submit-btn" value="<?php echo e(__('Pay')); ?> <?php echo e($flutterwave_data['amount'].get_charge_currency('flutterwave')); ?> <?php echo e(__('Now')); ?>"  />
                </div>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/frontend/payment/flutterwave.blade.php ENDPATH**/ ?>