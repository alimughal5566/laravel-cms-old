            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area">
                        ...
                        <h3 class="sub-title">
                            <?php
                                $subtitle = get_static_option('event_success_page_' . $user_select_lang_slug . '_subtitle');
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/events/attendance-success.blade.php ENDPATH**/ ?>