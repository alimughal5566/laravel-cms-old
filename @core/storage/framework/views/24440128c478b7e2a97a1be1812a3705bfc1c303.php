   ...
   <div class="srtipe-payment-inner-wrapper">
       ...
       <form action="<?php echo e($stripe_data['route']); ?>" method="post" id="payment-form">
           ...
           <div class="btn-wrapper">
               <button class="submit-btn"><?php echo e(__('Pay').site_currency_symbol().$stripe_data['price']); ?></button>
           </div>
       </form>
   </div>
</div>
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/payment/stripe.blade.php ENDPATH**/ ?>