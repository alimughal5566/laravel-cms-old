            ...
            <div class="col-lg-6">
                <div class="our-service-wrappper bg-main padding-top-100 padding-bottom-15">
                    <div class="section-title white padding-bottom-15 desktop-left">
                        ...
                        <p class="m-inherit"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_description')); ?></p>
                ...
                <div class="service-item-wrapper">
                    <div class="single-service-item">
                        <div class="service-img">
                            <div class="bg-image" <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_04_about_us_our_mission_image')); ?>></div>
                        </div>
                        <div class="service-text">
                            <div class="service-text-inner">
                                <h2 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_our_mission_title')); ?></h2>
                                <p><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_our_mission_description')); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="single-service-item">
                        <div class="service-text">
                            <div class="service-text-inner">
                                <h2 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_our_vision_title')); ?></h2>
                                <p><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_our_vision_description')); ?></p>
                            </div>
                        </div>
                        <div class="service-img style-01">
                            <div class="bg-image"  <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_04_about_us_our_vision_image')); ?>></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="experience-author bg-image"
                   <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_04_quality_area_image')); ?>
            ...
            <div class="col-lg-5 offset-lg-1 p-0">
                <div class="experience-content-03 section-padding">
                    <div class="content">
                        <h2 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_title')); ?></h2>
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/home-pages/home-04.blade.php ENDPATH**/ ?>