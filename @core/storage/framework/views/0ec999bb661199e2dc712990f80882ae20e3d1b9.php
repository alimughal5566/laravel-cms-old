...
<?php
    ...
    $get_body_font_family = get_static_option('body_font_family');
    $get_body_font_variant  = get_static_option('body_font_variant');
    $get_heading_font_family = get_static_option('heading_font_family');
    $get_heading_font_variant = get_static_option('heading_font_variant');
    $body_font_family = '';
    $body_font_variant = '';
    ...
    $heading_font_variant = '';
        ...
        $select_body_fonts = !empty($get_body_font_family) ? $get_body_font_family : 'Poppins';
        $select_heading_fonts = !empty($get_heading_font_family) ?  $get_heading_font_family : 'Poppins';
        $body_font_family_selected = ($get_body_font_family == $font_family) || $select_body_fonts == $font_family ? 'selected' : '' ;
        $heading_font_family_selected = ($get_heading_font_family == $font_family) || $select_heading_fonts == $font_family ? 'selected' : '' ;
        ...
        $heading_font_family .= sprintf('<option value="%1$s" %2$s>%3$s</option>',$font_family,$heading_font_family_selected,$font_family);
            ...
            if ($select_body_fonts == $font_family){
                ...
                $body_font_variant_selected_arr = !empty($get_body_font_variant) && gettype($get_body_font_variant) != 'string' ? unserialize($get_body_font_variant) : ['regular'];
            ...
            if ($select_heading_fonts == $font_family){
                foreach ($font_variant->variants as $variant){
                 $heading_font_variant_selected_arr = !empty($get_heading_font_variant) ? unserialize($get_heading_font_variant) : ['regular'];
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/general-settings/typograhpy.blade.php ENDPATH**/ ?>