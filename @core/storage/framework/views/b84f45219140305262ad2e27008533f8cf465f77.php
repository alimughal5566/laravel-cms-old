            ...
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="alert alert-warning"><?php echo e(__('database backup only work if you server allow to download database form your phpmyadmin')); ?></p>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/general-settings/backup.blade.php ENDPATH**/ ?>