                                        ...
                                        <table id="all_user_table" >
                                            ...
                                            <?php $__currentLoopData = $all_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(site_currency_symbol()); ?><?php echo e($data->package_price); ?></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                       ...
                                                       <form method='post' action='<?php echo e(route('admin.package.order.manage.delete',$data->id)); ?>'>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="order_status" class="form-control" id="order_status">
                                ...
                                <option value="complet"><?php echo e(__('Complete')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/package-order-manage/order-manage-pending.blade.php ENDPATH**/ ?>