                                ...
                                <table class="table table-default">
                                    ...
                                    <?php $__currentLoopData = $all_product_coupon; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($data->discount); ?><?php if($data->discount_type == 'percentage'): ?> % <?php else: ?> <?php echo e(site_currency_symbol()); ?> <?php endif; ?></td>
                                            ...
                                            <td>
                                                <a tabindex="0" class="btn btn-danger btn-xs mb-3 mr-1"
                                                   ...
                                                   title=""
                                                   data-content="
                                                   <h6>Are you sure to delete this coupon?</h6>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/products/coupon/all-coupon.blade.php ENDPATH**/ ?>