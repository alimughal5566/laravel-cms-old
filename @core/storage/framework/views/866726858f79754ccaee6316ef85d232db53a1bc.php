                ...
                <div class="view-quote-details-info" id="view-quote-details-info">
                    ...
                    <div class="view-quote-top-wrap">
                        ...
                        <div class="button-wrap">
                            <form action="<?php echo e(route('admin.product.invoice.generate')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="order_id" id="invoice_generate_order_field">
                                <button class="btn btn-secondary" type="submit"><?php echo e(__('Invoice')); ?></button>
                            </form>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/products/product-orders-all.blade.php ENDPATH**/ ?>