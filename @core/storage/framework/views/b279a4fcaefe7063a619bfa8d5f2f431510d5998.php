                                            ...
                                            <?php $__currentLoopData = $popup; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                       ...
                                                       <br>
                                                        <input type='submit' class='btn btn-danger btn-xs' value='<?php echo e(__('Yes,Delete')); ?>'>
                                                        </form>
                                                        ">
                                                            <i class="ti-trash"></i>
                                                        </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/popup-builder/popup-all.blade.php ENDPATH**/ ?>