                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="contact_map">
                            <div id="map">
                                <?php echo render_embed_google_map(get_static_option('home_page_01_contact_area_map_location')); ?>
                    ...
                    <div class="col-lg-10">
                        <div class="contact-info bg-white">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-title">
                                        <h4 class="title"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_contact_area_title')); ?></h4>
                                    </div>
                                </div>
                            </div>
                            <form action="<?php echo e(route('frontend.get.touch')); ?>" id="get_in_touch_form" method="post" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <?php echo render_form_field_for_frontend(get_static_option('get_in_touch_form_fields')); ?>

                                    </div>
                                    <div class="col-lg-12">
                                        <div class="btn-wrapper">
                                            <button type="submit" id="get_in_touch_submit_btn"
                                                    class="boxed-btn"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_contact_area_button_text')); ?></button>
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/partials/contact-section.blade.php ENDPATH**/ ?>