...
<head>
    ...
    <title><?php echo e(get_static_option('site_'.get_default_language().'_title'). __('Mail')); ?></title>
    <style>
        .mail-container {
            max-width: 650px;
            margin: 0 auto;
...
<body>
    <div class="mail-container">
        ...
        <p><?php echo e(__('You Have Message From '. get_static_option('site_'.get_default_language().'_title'))); ?></p>
        <table>
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/mail/contact.blade.php ENDPATH**/ ?>