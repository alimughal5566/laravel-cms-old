                ...
                <div class="col-lg-3">
                    <div class="product-widget-area">
                        ...
                        <div class="widget widget_price_filter">
                            ...
                            <p><span class="min_filter_price"><?php echo e(site_currency_symbol().$min_price); ?></span> <span class="max_filter_price"><?php echo e(site_currency_symbol().$max_price); ?></span></p>
                                ...
                                <div class="single-product-item-3 margin-bottom-30">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="price-wrap">
                                            <span class="price"><?php echo e(site_currency_symbol().$data->sale_price); ?></span>
                                            <?php if(!empty($data->regular_price)): ?><del class="del-price"><?php echo e(site_currency_symbol().$data->regular_price); ?></del><?php endif; ?>
                                        </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/pages/products/products.blade.php ENDPATH**/ ?>