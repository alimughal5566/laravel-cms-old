                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="home_page_quality_section_status"  <?php if(!empty(get_static_option('home_page_quality_section_status'))): ?> checked <?php endif; ?> id="home_page_quality_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="home_page_contact_section_status"  <?php if(!empty(get_static_option('home_page_contact_section_status'))): ?> checked <?php endif; ?> id="home_page_contact_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/pages/section-manage.blade.php ENDPATH**/ ?>