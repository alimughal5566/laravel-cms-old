    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        ...
        'TRY' => '₺','TTD' => 'TT$','TWD' => 'NT$','UAH' => '₴','UYU' => '$U','UZS' => 'so\'m','VND' => '₫','VUV' => 'VT','WST' => 'WS$','XCD' => '$','XPF' => '₣','YER' => '﷼','ZAR' => 'R','ZMW' => 'ZK'
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo e(get_static_option('site_default_payment_gateway')); ?>
                                        ...
                                        <div id="accordion-payment">
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="paypal_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#paypal_settings_content" aria-expanded="false" >
                                                            <span class="page-title"> <?php echo e(__('Paypal Settings')); ?></span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="paypal_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="switch">
                                                                <input type="checkbox" name="paypal_gateway"  <?php if(!empty(get_static_option('paypal_gateway'))): ?> checked <?php endif; ?> >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="paypal_test_mode"><strong><?php echo e(__('Enable Test Mode')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="paypal_test_mode"  <?php if(!empty(get_static_option('paypal_test_mode'))): ?> checked <?php endif; ?> >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Paypal Image')); ?>" data-modaltitle="<?php echo e(__('Upload Paypal Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                                    <?php echo e(__($paypal_image_btn_label)); ?>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Paytm Image')); ?>" data-modaltitle="<?php echo e(__('Upload Paytm Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Stripe Image')); ?>" data-modaltitle="<?php echo e(__('Upload Stripe Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Razorpay Image')); ?>" data-modaltitle="<?php echo e(__('Upload Razorpay Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select PayStack Image')); ?>" data-modaltitle="<?php echo e(__('Upload PayStack Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Manual Payment Logo Image')); ?>" data-modaltitle="<?php echo e(__('Upload Manual Payment Logo Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                                                                    <?php echo e(__($paytm_image_btn_label)); ?>
