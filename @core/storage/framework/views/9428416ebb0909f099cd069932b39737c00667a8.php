                    ...
                    <div class="col-lg-09 offset-lg-3">
                        <div class="experience-right">
                            <div class="experience-img">
                                <?php echo render_image_markup_by_attachment_id(get_static_option('home_page_01_about_us_video_background_image')); ?>

                            </div>
                            <div class="vdo-btn">
                                <a class="video-play-btn mfp-iframe"
                                   href="<?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_video_url')); ?>"><i
...
<div class="quality-area">
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-6">
                <div
                    class="quality-img" <?php echo render_background_image_markup_by_attachment_id(get_static_option('home_page_01_quality_area_background_image')); ?>></div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="quality-content-wrapper">
                        ...
                        <?php if(!empty(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_status'))): ?>
                            <div class="btn-wrapper margin-top-40">
                                <a href="<?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_url')); ?>"
                                   class="boxed-btn"><?php echo e(get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_title')); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        >
                            <div class="slider-inner-text">
                                ...
                                <div class="btn-wrapper padding-top-20">
                                    <a href="<?php echo e(route('frontend.work.single',$data->slug)); ?>"
                                       class="boxed-btn"><?php echo e(get_static_option('case_study_'.$user_select_lang_slug.'_read_more_text')); ?></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="single-price-plan-01 <?php if(!empty($data->highlight)): ?> style-03 active <?php endif; ?>">
                            <div class="price-header">
                                ...
                                <div class="price-wrap">
                                    <span class="price"><?php echo e(site_currency_symbol()); ?><?php echo e($data->price); ?></span><span
                            ...
                            >
                                <div class="content">
                                    <ul class="post-meta">
                                        ...
                                        <li>
                                            <div class="cats"><i class="fas fa-tags"></i><?php echo get_blog_category_by_id($data->id,'link'); ?></div>
                                        </li>
                                    </ul>
                                    <h4 class="title"><a
...
<?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/frontend/home-pages/home-01.blade.php ENDPATH**/ ?>