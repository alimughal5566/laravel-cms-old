                                ...
                                <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="nav-home-<?php echo e($lang->slug); ?>" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="donation_single_<?php echo e($lang->slug); ?>_form_title"  class="form-control" value="<?php echo e(get_static_option('donation_single_'.$lang->slug.'_form_title')); ?>" id="donation_single_<?php echo e($lang->slug); ?>_form_title">
                                        </div>
                                        <div class="form-group">
                                            <label for="donation_single_<?php echo e($lang->slug); ?>_form_button_text"><?php echo e(__('Form Button Title')); ?></label>
                                            <input type="text" name="donation_single_<?php echo e($lang->slug); ?>_form_button_text"  class="form-control" value="<?php echo e(get_static_option('donation_single_'.$lang->slug.'_form_button_text')); ?>" id="donation_single_<?php echo e($lang->slug); ?>_form_button_text">
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/dvrobin/Desktop/Sharifur-Backup/localhost/nexelit/@core/resources/views/backend/donations/donation-single-page-settings.blade.php ENDPATH**/ ?>