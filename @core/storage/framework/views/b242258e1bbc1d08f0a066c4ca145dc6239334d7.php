            ...
            <div class="col-lg-6">
                <div class="our-service-wrappper bg-main padding-top-100 padding-bottom-15">
                    <div class="section-title white padding-bottom-15 desktop-left">
                        ...
                        <p class="m-inherit"><?php echo get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_description'); ?></p>
                    ...
                    <div class="single-service-item">
                        ...
                        <div class="service-text">
                            <div class="service-text-inner">
                                ...
                                <p><?php echo get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_our_mission_description'); ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="single-service-item">
                        <div class="service-text">
                            <div class="service-text-inner">
                                ...
                                <p><?php echo get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_our_vision_description'); ?></p>
                            </div>
                        </div>
