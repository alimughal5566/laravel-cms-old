...
class HomePageController extends Controller
{
    ...
    public function home_01_update_section_manage(Request $request){
        ...
        $this->validate($request,[
            ...
            update_static_option('home_page_case_study_section_status',$request->home_page_case_study_section_status);
            ...
            update_static_option('home_page_quality_section_status',$request->home_page_quality_section_status);
            update_static_option('home_page_contact_section_status',$request->home_page_contact_section_status);
