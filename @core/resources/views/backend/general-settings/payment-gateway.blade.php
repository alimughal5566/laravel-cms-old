    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        ...
        'TRY' => '₺','TTD' => 'TT$','TWD' => 'NT$','UAH' => '₴','UYU' => '$U','UZS' => 'so\'m','VND' => '₫','VUV' => 'VT','WST' => 'WS$','XCD' => '$','XPF' => '₣','YER' => '﷼','ZAR' => 'R','ZMW' => 'ZK'
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{get_static_option('site_default_payment_gateway')}}
                                        ...
                                        <div id="accordion-payment">
                                            <div class="card">
                                                ...
                                                <div id="pcash_on_delivery_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="cash_on_delivery_gateway"><strong>{{__('Enable/Disable Cash On Delivery')}}</strong></label>
                                                            <label class="switch">
                                                ...
                                                <div id="paypal_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label class="switch">
                                                                <input type="checkbox" name="paypal_gateway"  @if(!empty(get_static_option('paypal_gateway'))) checked @endif >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="paypal_test_mode"><strong>{{__('Enable Test Mode')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="paypal_test_mode"  @if(!empty(get_static_option('paypal_test_mode'))) checked @endif >
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Paypal Image')}}" data-modaltitle="{{__('Upload Paypal Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                                    {{__($paypal_image_btn_label)}}
                                                                </button>
                                                            </div>
                                                            <small class="form-text text-muted">{{__('allowed image format: jpg,jpeg,png. Recommended image size 160x50')}}</small>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Paytm Image')}}" data-modaltitle="{{__('Upload Paytm Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Stripe Image')}}" data-modaltitle="{{__('Upload Stripe Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Razorpay Image')}}" data-modaltitle="{{__('Upload Razorpay Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select PayStack Image')}}" data-modaltitle="{{__('Upload PayStack Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="media-upload-btn-wrapper">
                                                                ...
                                                                <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Manual Payment Logo Image')}}" data-modaltitle="{{__('Upload Manual Payment Logo Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                                                    {{__($paytm_image_btn_label)}}
                                                                </button>
                                                            </div>
                                                            <small class="form-text text-muted">{{__('allowed image format: jpg,jpeg,png. Recommended image size 160x50')}}</small>
