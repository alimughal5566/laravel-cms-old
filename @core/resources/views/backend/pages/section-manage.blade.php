                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="home_page_quality_section_status"  @if(!empty(get_static_option('home_page_quality_section_status'))) checked @endif id="home_page_quality_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" name="home_page_contact_section_status"  @if(!empty(get_static_option('home_page_contact_section_status'))) checked @endif id="home_page_contact_section_status">
                                            <span class="slider"></span>
                                        </label>
                                    </div>
                                </div>
