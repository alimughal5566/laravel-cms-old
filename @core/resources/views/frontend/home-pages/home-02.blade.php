            ...
            <div class="col-lg-6">
                <div class="global-content">
                    ...
                    <div class="btn-wrapper padding-top-25">
                        <a href="{{get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_url')}}" class="boxed-btn reverse-color">{{get_static_option('home_page_01_'.$user_select_lang_slug.'_quality_area_button_title')}}</a>
                    </div>
                    @endif
                </div>
            </div>
    ...
    <div class="container-fluid p-0">
        <div class="row no-gutters">
            <div class="col-lg-6">
                ...
                >
                    <div class="vdo-btn">
                        <a class="video-play-btn mfp-iframe" href="{{get_static_option('home_page_01_'.$user_select_lang_slug.'_about_us_video_url')}}"><i class="fas fa-play"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
